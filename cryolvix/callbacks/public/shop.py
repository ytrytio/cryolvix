...
async def shop(callback: CallbackQuery, product_repo: ProductRepository, bot: Bot, **_):
    message = callback.message
    
    if (
        isinstance(message, InaccessibleMessage) 
        or not message or not message.chat
    ): return
